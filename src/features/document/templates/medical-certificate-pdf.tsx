...
// 1. Definición de estilos (Flexbox)
...
export const MedicalCertificatePDF = ({ data }: { data: CertificateData }) => (
  <Document>
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.table}>
        <View style={styles.lastRow}>
          ...
          <View style={styles.headerTitle}>
            <Text style={[styles.bold, { fontSize: 14, textAlign: 'center' }]}>CONSTANCIA DE EVALUACIÓN{"\n"}MÉDICA</Text>
          </View>
          <View style={styles.headerCode}>
            <View style={styles.headerCodeTop}>
              <Text style={styles.bold}>GP-S0-RE-06</Text>
            </View>
            <View style={styles.headerCodeBot}>
              <Text>Vers. 01 / ene 2023</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <Text style={styles.textLeft}>
        El paciente fue sometido a evaluación médica ocupacional determinando la siguiente <Text style={styles.bold}>CONDICIÓN MÉDICA OCUPACIONAL:</Text>
      </Text>
      ...
      <View style={styles.table}>
        ...
        <View style={styles.lastRow}>
          <View style={[styles.cellNoBorder, { minHeight: 60, width: '100%' }]}>
            <Text>{data.employerObservation || "Ninguna observación registrada."}</Text>
          </View>
        </View>
      </View>
